...
**PNAD and PNAD Contínua Household Income Microdata for Brazil, 1976–2025**
...
The repository software is distributed under the MIT License. The deposited dataset is licensed separately in the Zenodo record. The original PNAD and PNAD Contínua source microdata remain attributable to and governed by the Instituto Brasileiro de Geografia e Estatística (IBGE).
