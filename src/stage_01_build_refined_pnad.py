...
This module is the script version of ``01_gera_datasets.ipynb``. All
survey-year-specific rules are read from ``data/metadata/df_metadata.xlsx``,
generated by ``stage_00_build_metadata.py``.
"""
