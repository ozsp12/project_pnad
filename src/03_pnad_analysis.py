...
def run_analysis():
    ...
    tables = {
        "03_pnad_analysis__annual_statistics.csv": df_stats_year,
        "03_pnad_analysis__validation.csv": df_stats_validation,
        "03_pnad_analysis__descriptive_statistics.csv": df_descriptive_stats,
        "03_pnad_analysis__ccdf.csv": df_ccdf,
        "03_pnad_analysis__geometric_bins.csv": df_bins,
        "03_pnad_analysis__geometric_bins_preview.csv": df_bins_preview,
        "03_pnad_analysis__lorenz.csv": df_lorenz,
        "03_pnad_analysis__histograms.csv": df_histograms,
        "03_pnad_analysis__gini_validation.csv": df_gini_validation,
        "03_pnad_analysis__regime_fits.csv": df_regime_fits,
        "03_pnad_analysis__regime_curves.csv": df_regime_curves,
    }
