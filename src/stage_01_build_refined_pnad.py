...
All survey-year-specific rules are read from ``data/metadata/df_metadata.csv``,
generated by ``stage_00_build_metadata.py``. The CSV is the canonical persisted
metadata input because it is directly inspectable and diffable on GitHub.
"""
...
DEFAULT_METADATA_PATH = REPO_ROOT / "data" / "metadata" / "df_metadata.csv"
